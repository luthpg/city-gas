...
import { type DSL, dslToTs } from './dslToTs';
...
function generateTypeContent(
  ...
  return `// Auto-generated by city-gas-router\n\nexport type RouteNames = ${routeNames};\n\nexport interface RouteParams {\n${routeParams}\n}\n`;
}
...
export async function generate(rootDir: string) {
  ...
  console.log(`Generated types in ${typeOutputPath}`);
  ...
  console.log(`Generated routes map in ${routesOutputPath}`);
